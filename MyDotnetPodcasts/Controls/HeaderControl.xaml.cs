...
namespace MyDotnetPodcasts.Controls;
...
public partial class HeaderControl : ContentView
{
    ...
    public static readonly BindableProperty ShowSearchCategoriesProperty =
        BindableProperty.Create(nameof(ShowSearchCategories), typeof(bool), typeof(HeaderControl), true);
    ...
    public HeaderControl() => InitializeComponent();
